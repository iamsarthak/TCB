      ...
      <nav>
        <div class="nav-wrapper">
          ...
          <li><a href="sass.html">HOME</a></li>
              <li><a href="collapsible.html">SELL</a></li>
              <li><a href="collapsible.html">BUY</a></li>
        ...
        <div class="row">
            ...
            <form action="buy.php" method="get">
                 <input type="text" id="book" placeholder="Search" value="">
   	...
   	echo " Condition: " . $row['lastname'] . '<br />'."Cost :" . $row['email'] . '<br />';
